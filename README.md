...
- `Release`: runs the same checks, builds `release/cycleview.zip`, uploads it as an artifact, and attaches it to a GitHub Release when a tag like `v0.1.0` is pushed
